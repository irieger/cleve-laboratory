...
%   See http://it.mathworks.com/content/dam/mathworks/mathworks-dot-com/moler/exm/chapters/fern.pdf.    
%   See also FINITEFERN.
...
uicontrol( ...
   'background','white', ...
   'units','normalized', ...
   'position',[.02 .10 .12 .05], ...
   'style','pushbutton', ...
   'string','info', ...
   'callback','helpwin(''fern'')')
stop = uicontrol( ...
   'background','white', ...
   'units','normalized', ...
   'position',[.02 .02 .12 .05], ...
   'style','toggle', ...
   'string','exit');
drawnow
hold on
