...
thumb = nargin > 0;
m = 11-6*thumb;   % Determines number of grid points
speed = 1;
bvals = [1; 0; 0; 0; 0];
t = 0;
...
while bvals(5) == 0
   ...
   if thumb
       ...
       set(gcf,'menubar','none','tag','', ...
           ...
           'colormap',parula(64))
       b = zeros(5,1);
       b(1) = uicontrol('style','popup', ...
           'value',bvals(1), ...
           'units','normal', ...
           'position',[.15 .01 .14 .05], ...
           'string', {'1-d','square','disc','sector','L','bizcard'});
       for k = 2:5
          b(k) = uicontrol('style','toggle', ...
              'value',bvals(k), ...
              'units','normal', ...
              'position',[.15*k .01 .14 .05]);
       end
      ...
      if modes
         ...
         while fin
            ...
            if thumb
                ...
                fin = all(cell2mat(get(b,'value')) == bvals);
            end
         end
