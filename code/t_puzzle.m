...
% Playing pieces and puzzle shapes.
   ...
   function init_subplot(P)
      ...
      ax = get(gcf,'userdata');
      ax(2) = axes('units','normal', ...
          'position',[.02 .02 .24 .24]);
      shape = 1;
      t = P{shape};
   ...
   function exit = init_buttons(varargin)
      ...
      uicontrol( ...
           'units','normalized', ...
           'position',[.83 .14 .12 .05], ...
           'style','toggle', ...
           'string','info', ...
           'callback','web(''info/t_puzzle_info.html'')')       
      uicontrol( ...
           'units','normalized', ...
           'position',[.83 .08 .12 .05], ...
           'style','toggle', ...
           'string','restart', ...
           'callback',@restart_cb) 
      exit = uicontrol( ...
           'units','normalized', ...
           'position',[.83 .02 .12 .05], ...
           'style','toggle', ...
           'string','exit');
   end
   ...
   function restart_cb(varargin)
      ex = findobj('string','exit');
      set(ex,'value',1);
      figure
      t_puzzle
   end
