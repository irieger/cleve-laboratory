classdef CleveLaboratoryApp < handle
    %
    % Usage:
    %     app.CleveLaboratoryApp
    ...
    properties (Constant)
        AppPathBase = {'/CleveLaboratory/code'};
        AppClass = 'CleveLaboratoryApp';
        Increment = 1;
        Decrement = 0;
        Version = '13a';
    end
    ...
    methods
        ...
        function obj = CleveLaboratoryApp()
        ...
        function startApp(obj)
            ...
            mlock;
            CleveLaboratoryApp.refcount(obj.Increment);
            ...
            existVal = exist(fullfile(pwd,'lab1')); %#ok<EXIST>
            ...
            if (doesShadowExist && ~pathOne.equals(pathTwo))
                % We are trying to execute the wrong lab1
                errordlg(message('MATLAB:apps:runapp:WrongEntryPoint', 'lab1').getString, ...
